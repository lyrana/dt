...
namespace dnt
{
  ...
  */
  ...
  void move_neutral_particle_species(py::str species_name, py::object ctrl, py::object particle_P)
  {
    ...
    // Access the SAP without constructing a std::map
    auto psa = pseg_arr[std::string(species_name)].cast<SegmentedArrayPair<PT> *>();
        ...
        for (auto ipIn = 0; ipIn < npSeg; ipIn++)
          {
            ...
            */
            ...
            // We just have access to the particle SAP. We don't have access to pmesh_M?
