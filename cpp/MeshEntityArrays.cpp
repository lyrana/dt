/*! \file MeshEntityArrays.cpp
  ...
  \brief This file defines the C++ class MeshEntityArrays.
    ...
    Compute and store arrays of mesh entities needed by C++ particle movers.
    Currently, these are
      cell_neighbors_array
      cell_facet_normals_array
    See below for how these are defined.

    From dolfin/dolfin/mesh/MeshEntity.h, the definition of entities() is:
      ...
      @return     const unsigned int*
                  An array of indices of incident mesh entities of given dimension.
