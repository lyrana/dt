...
namespace dnt {
  ...
  PYBIND11_MODULE(numpy_types_solib, m)
  {
    ...
    PYBIND11_NUMPY_DTYPE_EX(Pstruct<Ptype::spherical_r>, r_, "r", r0_, "r0", ur_, "ur", weight_, "weight", bitflags_, "bitflags", cell_index_, "cell_index", unique_ID_, "unique_ID", crossings_, "crossings");
