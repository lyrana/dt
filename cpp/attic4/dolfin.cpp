...
//  double p0[2] = mesh.coordinates()[v0];
//  double p1[2] = mesh.coordinates()[v1];
//  double p2[2] = mesh.coordinates()[v2];
//  double p0[2]; p0[0] = mesh.coordinates()[v0][0]; p0[1] = mesh.coordinates()[v0][1]; 
//  double p1[2]; p1[0] = mesh.coordinates()[v1][0]; p1[1] = mesh.coordinates()[v1][1]; 
//  double p2[2]; p2[0] = mesh.coordinates()[v2][0]; p2[1] = mesh.coordinates()[v2][1]; 

  double* p0 = &mesh.coordinates()[v0];
  double* p1 = &mesh.coordinates()[v1];
  double* p2 = &mesh.coordinates()[v2];
