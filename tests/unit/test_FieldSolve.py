...
#        fI_M = im_m.import_module(field_infrastructure_module)
        ...
        mesh_M = UserMesh1DS_C(umi, compute_tree=False, plot_flag=self.plot_mesh, plot_title=plotTitle)
#        yesno = raw_input("Just called UserMesh1DS_C() in test_1_1D_spherical_laplace_solver")
        ...
        plotTitle = os.path.basename(__file__) + ": " + sys._getframe().f_code.co_name
        laplacesolve.solve_for_phi(plot_flag=self.plot_results, plot_title=plotTitle)
...
#        fI_M = im_m.import_module(field_infrastructure_module)
        ...
        mesh_M = UserMesh2DCirc_C(umi, compute_tree=False, plot_flag=self.plot_mesh)
...
#class TestFieldSolve(unittest.TestCase):
    def test_3_1D_poisson_solver(self):
        ...
        mesh1d_M = Mesh_C(mesh_file='mesh_2cell_1D.xml', coordinate_system=coordinateSystem, field_boundary_marker_file='mesh_2cell_1D_Fbcs.xml', compute_dictionaries=True, compute_cpp_arrays=False, compute_tree=True, plot_flag=self.plot_mesh)
...
#        self.b = df_m.assemble(self.L)
        ...
        # Solve for the potential
        plotTitle = os.path.basename(__file__) + ": " + sys._getframe().f_code.co_name
        poissonsolve.solve_for_phi(plot_flag=self.plot_results, plot_title=plotTitle)
...
#class TestFieldSolve(unittest.TestCase):
    def test_4_1D_poisson_solver(self):
        ...
        mesh1d_M = Mesh_C(mesh_file='mesh_1D_radial.xml', coordinate_system=coordinateSystem, field_boundary_marker_file='mesh_1D_radial_Fbcs.xml', compute_dictionaries=True, compute_cpp_arrays=False, compute_tree=True, plot_flag=self.plot_mesh)
...
#        poissonsolve.solve_for_phi(plot_flag=plotFlag, plot_title=plotTitle)
        ...
        potentialsolve.solve_for_phi(assembled_charge=chargeDensity_F, assembled_charge_factor=spacechargeFactor, plot_flag=self.plot_results, plot_title=plotTitle)
...
#class TestFieldSolve(unittest.TestCase):
    def test_5_1D_poisson_solver(self):
        ...
        # Create a mesh object and read in the mesh.
        coordinateSystem = '1D-spherical-radial'
        mesh1d_M = Mesh_C(mesh_file='mesh_1D_radial_r0.xml', coordinate_system=coordinateSystem, field_boundary_marker_file='mesh_1D_radial_r0_Fbcs.xml', compute_dictionaries=True, compute_cpp_arrays=False, compute_tree=True, plot_flag=self.plot_mesh)
