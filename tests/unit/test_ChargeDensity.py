...
#class TestChargeDensity(unittest.TestCase):
    def test_1_interpolate_particle_density_to_1D_mesh(self):
...
#            dofNumberDensity_F.interpolate_delta_function_to_dofs(p) # This doesn't have to search for the cell containing p.
        ...
        # get_local() returns a numpy array that has a copy of the values in vector().
...
#            print "dofNumberDensityCalc, dofNumberDensityExpected =", dofNumberDensityCalc[idof], dofNumberDensityExpected[ivert]
        ...
        return
#    def test_1_interpolate_particle_density_to_1D_mesh(self):ENDDEF

#class TestChargeDensity(unittest.TestCase):
    def test_2_particle_densities_on_2D_mesh(self):
        """Compute the nodal and cell number densities generated by line particles on a
           2D mesh.
           ...
           See test_ChargeDensity.ods:test_2 for hand-calculated values of the two
           densities.
...
#        print fncName, "cellNumberDensityCalc =", cellNumberDensityCalc
        ...
        # The expected cell number-density values from test_ChargeDensity.ods:test_2
...
#            cellVol = mesh_M.cell_volume_dict[cellIndex]
            ...
            # There's only 1 DoF in the cell, since this function uses constant DG
            # elements. Even so, cell_dofs() returns an array, with one element.
...
#class TestChargeDensity(unittest.TestCase):
    def test_3_compute_charge_density_on_2D_mesh(self):
...
#            print "chargeDensityCalc, chargeDensityExpected =", chargeDensityCalc[idof], chargeDensityExpected[ivert]
        ...
        return
#    def test_3_compute_charge_density_on_2D_mesh(self):ENDDEF


#class TestChargeDensity(unittest.TestCase):
    def test_4_compute_charge_density_on_1D_mesh(self):
...
#        field_boundary_marker_file >> mesh1d_M.field_boundary_marker
        ...
        return
#    def test_4_compute_charge_density_on_1D_mesh(self):ENDDEF
